...
**浏览GitHub上其他Python项目，以及你完成本次任务的过程，对你管理个人项目、展示个人技能有何启发？  
1.规范归纳整理的重要性。  好的规范整理，能够利于自己未来查看个人项目，或是别人查看自己的项目。
2.好的项目库的展示，能够很清晰的看见自己对于项目编写的历史变迁。同时也能作为以后该技能个人展示的一个很好的作品。  

**你计划如何利用这个仓库记录你未来的学习？  
1.可以将未来的有意义的练习项目、课程作业和个人作品都分门别类地上传至此。  
2.为每个项目或每个学习阶段创建详细的笔记，记录遇到的问题和解决方案，便于自己未来的发展，每一步都能留痕，可视化。  
3.每段时间回顾一次仓库的内容，总结学习成果，并规划下一阶段的方向，清晰每个时间段的学习目标。 
